...
const features = [
  {
    ...
    description: 'Collect feedback right where users experience your features. No more generic surveys.',
    icon: (
  ...
  },
  {
    ...
    description: 'npm install, wrap your app, add one component. That\'s it. Start collecting feedback today.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Star ratings, thumbs up/down, or detailed feedback. Choose what works for each feature.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-slate-600">not just your app</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Add contextual feedback buttons to any React component in minutes.
              Know exactly what users think about each feature you ship.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Stop building feedback systems</h2>
            <p className="text-xl text-gray-600">
              Building it yourself costs more than you think.
            </p>
          </div>
