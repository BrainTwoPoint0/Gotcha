        ...
        <div className="grid md:grid-cols-[2fr_1fr_1fr] gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="https://www.npmjs.com/package/gotcha-feedback" className="hover:text-white">npm</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-white font-semibold mb-4">Contact</h4>
            <ul className="space-y-2 text-sm">
              <li><a href="mailto:info@braintwopoint0.com" className="hover:text-white">info@braintwopoint0.com</a></li>
            </ul>
          </div>
        </div>
