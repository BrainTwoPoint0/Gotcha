...
export function MetadataFieldsManager({
  ...
  return (
    <div className="space-y-8">
      {/* Configured Fields */}
      <div className="bg-editorial-paper rounded-md border border-editorial-neutral-2">
        <div className="p-4 sm:p-6 border-b border-editorial-neutral-2">
          <h2 className="text-lg font-semibold text-editorial-ink">Configured Fields</h2>
          <p className="text-sm text-editorial-neutral-3">
            These fields are available for user segmentation
          </p>
        </div>

        {configuredFields.length === 0 ? (
          <div className="p-6 text-center text-editorial-neutral-3">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <code className="text-xs bg-editorial-ink/[0.04] px-1.5 py-0.5 rounded text-editorial-neutral-3">
                          {field.fieldKey}
                        </code>
                      ...
                      <p className="text-sm text-editorial-neutral-3 mt-1">
      ...
      {discoveredFields.length > 0 && (
        <div className="bg-editorial-paper rounded-md border border-editorial-neutral-2">
          <div className="p-4 sm:p-6 border-b border-editorial-neutral-2">
            <h2 className="text-lg font-semibold text-editorial-ink">Discovered Fields</h2>
            <p className="text-sm text-editorial-neutral-3">
          ...
          <div className="divide-y divide-gray-200">
            {discoveredFields.map((field) => (
              ...
              >
                <div>
                  <div className="flex items-center gap-2">
                    <code className="font-medium text-editorial-ink">{field.key}</code>
                    <span className="text-xs text-editorial-neutral-3">
